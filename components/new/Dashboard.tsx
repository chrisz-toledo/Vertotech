...
import MorningBriefingWidget from './dashboard/MorningBriefingWidget';
import LiveStatusWidget from './dashboard/LiveStatusWidget';
import AlertsWidget from './dashboard/AlertsWidget';
import StatCard from './dashboard/StatCard';
import { UsersGroupIcon } from '../icons/UsersGroupIcon';
import { BuildingIcon } from '../icons/BuildingIcon';
import { BriefcaseIcon } from '../icons/new/BriefcaseIcon';
import FinancialSummaryWidget from './dashboard/FinancialSummaryWidget';
import ActionItemsWidget from './dashboard/ActionItemsWidget';
import OperationalSummaryWidget from './dashboard/OperationalSummaryWidget';
